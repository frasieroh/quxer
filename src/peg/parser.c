...
arena_ptrs_t prealloc_idx_0 = *arena_prealloc(state->arena, &prealloc_idx_0);
uint32_t current_position_0 = start_0;
uint32_t start_1 = current_position_0;
rnode_t* result_1 = NULL;
arena_ptrs_t prealloc_idx_1 = *arena_prealloc(state->arena, &prealloc_idx_1);
...
do {
result_2 = NULL;
arena_ptrs_t prealloc_idx_2 = *arena_prealloc(state->arena, &prealloc_idx_2);
uint32_t current_position_2 = start_2;
uint32_t start_3 = current_position_2;
rnode_t* result_3 = NULL;
arena_ptrs_t prealloc_idx_3 = *arena_prealloc(state->arena, &prealloc_idx_3);
...
arena_ptrs_t prealloc_idx_4 = *arena_prealloc(state->arena, &prealloc_idx_4);
...
arena_ptrs_t prealloc_idx_5 = *arena_prealloc(state->arena, &prealloc_idx_5);
...
arena_ptrs_t prealloc_idx_6 = *arena_prealloc(state->arena, &prealloc_idx_6);
uint32_t start_7 = start_6;
rnode_t* result_7 = NULL;
arena_ptrs_t prealloc_idx_7 = *arena_prealloc(state->arena, &prealloc_idx_7);
...
arena_ptrs_t prealloc_idx_8 = *arena_prealloc(state->arena, &prealloc_idx_8);
...
do {
result_9 = NULL;
arena_ptrs_t prealloc_idx_9 = *arena_prealloc(state->arena, &prealloc_idx_9);
uint32_t start_10 = start_9;
rnode_t* result_10 = NULL;
arena_ptrs_t prealloc_idx_10 = *arena_prealloc(state->arena, &prealloc_idx_10);
...
arena_ptrs_t prealloc_idx_11 = *arena_prealloc(state->arena, &prealloc_idx_11);
...
arena_ptrs_t prealloc_idx_12 = *arena_prealloc(state->arena, &prealloc_idx_12);
...
arena_ptrs_t prealloc_idx_13 = *arena_prealloc(state->arena, &prealloc_idx_13);
...
do {
result_14 = NULL;
arena_ptrs_t prealloc_idx_14 = *arena_prealloc(state->arena, &prealloc_idx_14);
uint32_t start_15 = start_14;
rnode_t* result_15 = NULL;
arena_ptrs_t prealloc_idx_15 = *arena_prealloc(state->arena, &prealloc_idx_15);
...
arena_ptrs_t prealloc_idx_16 = *arena_prealloc(state->arena, &prealloc_idx_16);
...
arena_ptrs_t prealloc_idx_17 = *arena_prealloc(state->arena, &prealloc_idx_17);
...
arena_ptrs_t prealloc_idx_18 = *arena_prealloc(state->arena, &prealloc_idx_18);
uint32_t current_position_18 = start_18;
uint32_t start_19 = current_position_18;
rnode_t* result_19 = NULL;
arena_ptrs_t prealloc_idx_19 = *arena_prealloc(state->arena, &prealloc_idx_19);
...
arena_ptrs_t prealloc_idx_20 = *arena_prealloc(state->arena, &prealloc_idx_20);
...
arena_ptrs_t prealloc_idx_21 = *arena_prealloc(state->arena, &prealloc_idx_21);
...
arena_ptrs_t prealloc_idx_22 = *arena_prealloc(state->arena, &prealloc_idx_22);
...
arena_ptrs_t prealloc_idx_23 = *arena_prealloc(state->arena, &prealloc_idx_23);
...
arena_ptrs_t prealloc_idx_24 = *arena_prealloc(state->arena, &prealloc_idx_24);
...
arena_ptrs_t prealloc_idx_25 = *arena_prealloc(state->arena, &prealloc_idx_25);
...
do {
result_26 = NULL;
arena_ptrs_t prealloc_idx_26 = *arena_prealloc(state->arena, &prealloc_idx_26);
uint32_t start_27 = start_26;
rnode_t* result_27 = NULL;
arena_ptrs_t prealloc_idx_27 = *arena_prealloc(state->arena, &prealloc_idx_27);
...
arena_ptrs_t prealloc_idx_28 = *arena_prealloc(state->arena, &prealloc_idx_28);
...
arena_ptrs_t prealloc_idx_29 = *arena_prealloc(state->arena, &prealloc_idx_29);
...
arena_ptrs_t prealloc_idx_30 = *arena_prealloc(state->arena, &prealloc_idx_30);
...
arena_ptrs_t prealloc_idx_31 = *arena_prealloc(state->arena, &prealloc_idx_31);
...
arena_ptrs_t prealloc_idx_32 = *arena_prealloc(state->arena, &prealloc_idx_32);
uint32_t current_position_32 = start_32;
uint32_t start_33 = current_position_32;
rnode_t* result_33 = NULL;
arena_ptrs_t prealloc_idx_33 = *arena_prealloc(state->arena, &prealloc_idx_33);
...
arena_ptrs_t prealloc_idx_34 = *arena_prealloc(state->arena, &prealloc_idx_34);
...
do {
result_35 = NULL;
arena_ptrs_t prealloc_idx_35 = *arena_prealloc(state->arena, &prealloc_idx_35);
uint32_t current_position_35 = start_35;
uint32_t start_36 = current_position_35;
rnode_t* result_36 = NULL;
arena_ptrs_t prealloc_idx_36 = *arena_prealloc(state->arena, &prealloc_idx_36);
...
arena_ptrs_t prealloc_idx_37 = *arena_prealloc(state->arena, &prealloc_idx_37);
...
arena_ptrs_t prealloc_idx_38 = *arena_prealloc(state->arena, &prealloc_idx_38);
...
arena_ptrs_t prealloc_idx_39 = *arena_prealloc(state->arena, &prealloc_idx_39);
...
arena_ptrs_t prealloc_idx_40 = *arena_prealloc(state->arena, &prealloc_idx_40);
uint32_t current_position_40 = start_40;
uint32_t start_41 = current_position_40;
rnode_t* result_41 = NULL;
arena_ptrs_t prealloc_idx_41 = *arena_prealloc(state->arena, &prealloc_idx_41);
...
arena_ptrs_t prealloc_idx_42 = *arena_prealloc(state->arena, &prealloc_idx_42);
...
do {
result_43 = NULL;
arena_ptrs_t prealloc_idx_43 = *arena_prealloc(state->arena, &prealloc_idx_43);
uint32_t current_position_43 = start_43;
uint32_t start_44 = current_position_43;
rnode_t* result_44 = NULL;
arena_ptrs_t prealloc_idx_44 = *arena_prealloc(state->arena, &prealloc_idx_44);
...
arena_ptrs_t prealloc_idx_45 = *arena_prealloc(state->arena, &prealloc_idx_45);
...
arena_ptrs_t prealloc_idx_46 = *arena_prealloc(state->arena, &prealloc_idx_46);
uint32_t start_47 = start_46;
rnode_t* result_47 = NULL;
arena_ptrs_t prealloc_idx_47 = *arena_prealloc(state->arena, &prealloc_idx_47);
uint32_t current_position_47 = start_47;
uint32_t start_48 = current_position_47;
rnode_t* result_48 = NULL;
arena_ptrs_t prealloc_idx_48 = *arena_prealloc(state->arena, &prealloc_idx_48);
...
arena_ptrs_t prealloc_idx_49 = *arena_prealloc(state->arena, &prealloc_idx_49);
uint32_t start_50 = start_49;
rnode_t* result_50 = NULL;
arena_ptrs_t prealloc_idx_50 = *arena_prealloc(state->arena, &prealloc_idx_50);
uint32_t current_position_50 = start_50;
uint32_t start_51 = current_position_50;
rnode_t* result_51 = NULL;
arena_ptrs_t prealloc_idx_51 = *arena_prealloc(state->arena, &prealloc_idx_51);
rnode_t* result_51_nt = call_eval(EVAL_ws, state, text, text_length, start_51);
if (result_51_nt) {
result_51 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_51->flags = 0;
...
if (result_51 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_50);
goto exit_50;
}
current_position_50 = result_51->end;
uint32_t start_52 = current_position_50;
rnode_t* result_52 = NULL;
arena_ptrs_t prealloc_idx_52 = *arena_prealloc(state->arena, &prealloc_idx_52);
...
if (i_52 == 2 - 1) {
result_52 = arena_malloc(state->arena, sizeof(rnode_t));
result_52->flags = 0;
...
arena_ptrs_t prealloc_idx_53 = *arena_prealloc(state->arena, &prealloc_idx_53);
...
arena_ptrs_t prealloc_idx_54 = *arena_prealloc(state->arena, &prealloc_idx_54);
rnode_t* result_54_nt = call_eval(EVAL_code, state, text, text_length, start_54);
if (result_54_nt) {
result_54 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
...
arena_ptrs_t prealloc_idx_55 = *arena_prealloc(state->arena, &prealloc_idx_55);
...
arena_ptrs_t prealloc_idx_56 = *arena_prealloc(state->arena, &prealloc_idx_56);
...
arena_reset_sp(state->arena, &prealloc_idx_56);
break;
}
}
if (result_56 == NULL) {
...
result_50 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 6);
result_50->flags = 0;
...
arena_ptrs_t prealloc_idx_57 = *arena_prealloc(state->arena, &prealloc_idx_57);
uint32_t current_position_57 = start_57;
uint32_t start_58 = current_position_57;
rnode_t* result_58 = NULL;
arena_ptrs_t prealloc_idx_58 = *arena_prealloc(state->arena, &prealloc_idx_58);
rnode_t* result_58_nt = call_eval(EVAL_postfix, state, text, text_length, start_58);
if (result_58_nt) {
result_58 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
...
if (result_58 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_57);
goto exit_57;
}
current_position_57 = result_58->end;
uint32_t start_59 = current_position_57;
rnode_t* result_59 = NULL;
arena_ptrs_t prealloc_idx_59 = *arena_prealloc(state->arena, &prealloc_idx_59);
uint32_t start_60 = start_59;
rnode_t* result_60 = NULL;
arena_ptrs_t prealloc_idx_60 = *arena_prealloc(state->arena, &prealloc_idx_60);
uint32_t current_position_60 = start_60;
uint32_t start_61 = current_position_60;
rnode_t* result_61 = NULL;
arena_ptrs_t prealloc_idx_61 = *arena_prealloc(state->arena, &prealloc_idx_61);
rnode_t* result_61_nt = call_eval(EVAL_ws, state, text, text_length, start_61);
if (result_61_nt) {
result_61 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_61->flags = 0;
...
arena_ptrs_t prealloc_idx_62 = *arena_prealloc(state->arena, &prealloc_idx_62);
...
if (i_62 == 2 - 1) {
result_62 = arena_malloc(state->arena, sizeof(rnode_t));
result_62->flags = 0;
...
arena_ptrs_t prealloc_idx_63 = *arena_prealloc(state->arena, &prealloc_idx_63);
...
arena_reset_sp(state->arena, &prealloc_idx_63);
}
if (result_63 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_60);
goto exit_60;
...
arena_ptrs_t prealloc_idx_64 = *arena_prealloc(state->arena, &prealloc_idx_64);
...
arena_reset_sp(state->arena, &prealloc_idx_64);
}
if (result_64 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_60);
goto exit_60;
...
arena_ptrs_t prealloc_idx_65 = *arena_prealloc(state->arena, &prealloc_idx_65);
rnode_t* result_65_nt = call_eval(EVAL_ws, state, text, text_length, start_65);
if (result_65_nt) {
result_65 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_65->flags = 0;
...
arena_ptrs_t prealloc_idx_66 = *arena_prealloc(state->arena, &prealloc_idx_66);
...
if (i_66 == 2 - 1) {
result_66 = arena_malloc(state->arena, sizeof(rnode_t));
result_66->flags = 0;
...
result_60 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 6);
result_60->flags = 0;
...
result_59 = arena_malloc(state->arena, sizeof(rnode_t));
...
result_57 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 2);
...
arena_ptrs_t prealloc_idx_67 = *arena_prealloc(state->arena, &prealloc_idx_67);
uint32_t current_position_67 = start_67;
uint32_t start_68 = current_position_67;
rnode_t* result_68 = NULL;
arena_ptrs_t prealloc_idx_68 = *arena_prealloc(state->arena, &prealloc_idx_68);
...
arena_ptrs_t prealloc_idx_69 = *arena_prealloc(state->arena, &prealloc_idx_69);
uint32_t start_70 = start_69;
rnode_t* result_70 = NULL;
arena_ptrs_t prealloc_idx_70 = *arena_prealloc(state->arena, &prealloc_idx_70);
uint32_t current_position_70 = start_70;
uint32_t start_71 = current_position_70;
rnode_t* result_71 = NULL;
arena_ptrs_t prealloc_idx_71 = *arena_prealloc(state->arena, &prealloc_idx_71);
...
arena_ptrs_t prealloc_idx_72 = *arena_prealloc(state->arena, &prealloc_idx_72);
...
if (i_72 == 2 - 1) {
result_72 = arena_malloc(state->arena, sizeof(rnode_t));
result_72->flags = 0;
...
arena_ptrs_t prealloc_idx_73 = *arena_prealloc(state->arena, &prealloc_idx_73);
rnode_t* result_73_nt = call_eval(EVAL_ws, state, text, text_length, start_73);
if (result_73_nt) {
result_73 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_73->flags = 0;
...
arena_ptrs_t prealloc_idx_74 = *arena_prealloc(state->arena, &prealloc_idx_74);
...
arena_ptrs_t prealloc_idx_75 = *arena_prealloc(state->arena, &prealloc_idx_75);
...
arena_ptrs_t prealloc_idx_76 = *arena_prealloc(state->arena, &prealloc_idx_76);
...
if (i_76 == 2 - 1) {
result_76 = arena_malloc(state->arena, sizeof(rnode_t));
result_76->flags = 0;
...
result_70 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 6);
result_70->flags = 0;
...
exit_70:
if (result_70) {
result_69 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_69->end = result_70->end;
result_69->num_children = 1;
result_69->children[0] = result_70;
} else {
result_69 = arena_malloc(state->arena, sizeof(rnode_t));
...
result_67 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 2);
...
arena_ptrs_t prealloc_idx_77 = *arena_prealloc(state->arena, &prealloc_idx_77);
uint32_t start_78 = start_77;
rnode_t* result_78 = NULL;
arena_ptrs_t prealloc_idx_78 = *arena_prealloc(state->arena, &prealloc_idx_78);
uint32_t current_position_78 = start_78;
uint32_t start_79 = current_position_78;
rnode_t* result_79 = NULL;
arena_ptrs_t prealloc_idx_79 = *arena_prealloc(state->arena, &prealloc_idx_79);
...
arena_ptrs_t prealloc_idx_80 = *arena_prealloc(state->arena, &prealloc_idx_80);
rnode_t* result_80_nt = call_eval(EVAL_ws, state, text, text_length, start_80);
if (result_80_nt) {
result_80 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_80->flags = 0;
...
arena_ptrs_t prealloc_idx_81 = *arena_prealloc(state->arena, &prealloc_idx_81);
...
result_78 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
exit_78:
if (result_78 != NULL) {
result_77 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_77->flags = 0;
...
arena_ptrs_t prealloc_idx_82 = *arena_prealloc(state->arena, &prealloc_idx_82);
uint32_t current_position_82 = start_82;
uint32_t start_83 = current_position_82;
rnode_t* result_83 = NULL;
arena_ptrs_t prealloc_idx_83 = *arena_prealloc(state->arena, &prealloc_idx_83);
...
arena_ptrs_t prealloc_idx_84 = *arena_prealloc(state->arena, &prealloc_idx_84);
rnode_t* result_84_nt = call_eval(EVAL_ws, state, text, text_length, start_84);
if (result_84_nt) {
result_84 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_84->flags = 0;
...
arena_ptrs_t prealloc_idx_85 = *arena_prealloc(state->arena, &prealloc_idx_85);
...
result_82 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
arena_ptrs_t prealloc_idx_86 = *arena_prealloc(state->arena, &prealloc_idx_86);
...
if (i_86 == 1 - 1) {
result_86 = arena_malloc(state->arena, sizeof(rnode_t));
result_86->flags = 0;
...
ret->prealloc = prealloc_idx_86;
ret->result = result_86;
return;
}
...
arena_ptrs_t prealloc_idx_87 = *arena_prealloc(state->arena, &prealloc_idx_87);
...
if (i_87 == 1 - 1) {
result_87 = arena_malloc(state->arena, sizeof(rnode_t));
result_87->flags = 0;
...
ret->prealloc = prealloc_idx_87;
ret->result = result_87;
return;
}
...
arena_ptrs_t prealloc_idx_88 = *arena_prealloc(state->arena, &prealloc_idx_88);
uint32_t start_89 = start_88;
rnode_t* result_89 = NULL;
arena_ptrs_t prealloc_idx_89 = *arena_prealloc(state->arena, &prealloc_idx_89);
uint32_t current_position_89 = start_89;
uint32_t start_90 = current_position_89;
rnode_t* result_90 = NULL;
arena_ptrs_t prealloc_idx_90 = *arena_prealloc(state->arena, &prealloc_idx_90);
...
arena_ptrs_t prealloc_idx_91 = *arena_prealloc(state->arena, &prealloc_idx_91);
...
arena_ptrs_t prealloc_idx_92 = *arena_prealloc(state->arena, &prealloc_idx_92);
rnode_t* result_92_nt = call_eval(EVAL_star, state, text, text_length, start_92);
if (result_92_nt) {
result_92 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_92->flags = 0;
...
result_89 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
exit_89:
if (result_89 != NULL) {
result_88 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_88->flags = 0;
...
arena_ptrs_t prealloc_idx_93 = *arena_prealloc(state->arena, &prealloc_idx_93);
uint32_t current_position_93 = start_93;
uint32_t start_94 = current_position_93;
rnode_t* result_94 = NULL;
arena_ptrs_t prealloc_idx_94 = *arena_prealloc(state->arena, &prealloc_idx_94);
rnode_t* result_94_nt = call_eval(EVAL_group, state, text, text_length, start_94);
if (result_94_nt) {
result_94 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
...
arena_ptrs_t prealloc_idx_95 = *arena_prealloc(state->arena, &prealloc_idx_95);
...
arena_ptrs_t prealloc_idx_96 = *arena_prealloc(state->arena, &prealloc_idx_96);
rnode_t* result_96_nt = call_eval(EVAL_plus, state, text, text_length, start_96);
if (result_96_nt) {
result_96 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_96->flags = 0;
...
result_93 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
arena_ptrs_t prealloc_idx_97 = *arena_prealloc(state->arena, &prealloc_idx_97);
uint32_t current_position_97 = start_97;
uint32_t start_98 = current_position_97;
rnode_t* result_98 = NULL;
arena_ptrs_t prealloc_idx_98 = *arena_prealloc(state->arena, &prealloc_idx_98);
...
arena_ptrs_t prealloc_idx_99 = *arena_prealloc(state->arena, &prealloc_idx_99);
...
arena_ptrs_t prealloc_idx_100 = *arena_prealloc(state->arena, &prealloc_idx_100);
...
result_97 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
exit_88:
ret->prealloc = prealloc_idx_88;
ret->result = result_88;
return;
}
...
arena_ptrs_t prealloc_idx_101 = *arena_prealloc(state->arena, &prealloc_idx_101);
...
ret->prealloc = prealloc_idx_101;
ret->result = result_101;
return;
}
...
arena_ptrs_t prealloc_idx_102 = *arena_prealloc(state->arena, &prealloc_idx_102);
...
if (i_102 == 1 - 1) {
result_102 = arena_malloc(state->arena, sizeof(rnode_t));
result_102->flags = 0;
...
ret->prealloc = prealloc_idx_102;
ret->result = result_102;
return;
}
...
arena_ptrs_t prealloc_idx_103 = *arena_prealloc(state->arena, &prealloc_idx_103);
...
ret->prealloc = prealloc_idx_103;
ret->result = result_103;
return;
}
...
arena_ptrs_t prealloc_idx_104 = *arena_prealloc(state->arena, &prealloc_idx_104);
uint32_t start_105 = start_104;
rnode_t* result_105 = NULL;
arena_ptrs_t prealloc_idx_105 = *arena_prealloc(state->arena, &prealloc_idx_105);
uint32_t current_position_105 = start_105;
uint32_t start_106 = current_position_105;
rnode_t* result_106 = NULL;
arena_ptrs_t prealloc_idx_106 = *arena_prealloc(state->arena, &prealloc_idx_106);
...
if (i_106 == 1 - 1) {
result_106 = arena_malloc(state->arena, sizeof(rnode_t));
result_106->flags = 0;
...
arena_ptrs_t prealloc_idx_107 = *arena_prealloc(state->arena, &prealloc_idx_107);
rnode_t* result_107_nt = call_eval(EVAL_ws, state, text, text_length, start_107);
if (result_107_nt) {
result_107 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_107->flags = 0;
...
arena_ptrs_t prealloc_idx_108 = *arena_prealloc(state->arena, &prealloc_idx_108);
...
arena_ptrs_t prealloc_idx_109 = *arena_prealloc(state->arena, &prealloc_idx_109);
...
arena_ptrs_t prealloc_idx_110 = *arena_prealloc(state->arena, &prealloc_idx_110);
...
if (i_110 == 1 - 1) {
result_110 = arena_malloc(state->arena, sizeof(rnode_t));
result_110->flags = 0;
...
result_105 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 5);
...
arena_ptrs_t prealloc_idx_111 = *arena_prealloc(state->arena, &prealloc_idx_111);
uint32_t current_position_111 = start_111;
uint32_t start_112 = current_position_111;
rnode_t* result_112 = NULL;
arena_ptrs_t prealloc_idx_112 = *arena_prealloc(state->arena, &prealloc_idx_112);
...
if (i_112 == 1 - 1) {
result_112 = arena_malloc(state->arena, sizeof(rnode_t));
result_112->flags = 0;
...
arena_ptrs_t prealloc_idx_113 = *arena_prealloc(state->arena, &prealloc_idx_113);
...
arena_ptrs_t prealloc_idx_114 = *arena_prealloc(state->arena, &prealloc_idx_114);
...
arena_ptrs_t prealloc_idx_115 = *arena_prealloc(state->arena, &prealloc_idx_115);
rnode_t* result_115_nt = call_eval(EVAL_ws, state, text, text_length, start_115);
if (result_115_nt) {
result_115 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_115->flags = 0;
...
arena_ptrs_t prealloc_idx_116 = *arena_prealloc(state->arena, &prealloc_idx_116);
...
if (i_116 == 1 - 1) {
result_116 = arena_malloc(state->arena, sizeof(rnode_t));
result_116->flags = 0;
...
result_111 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 5);
...
arena_ptrs_t prealloc_idx_117 = *arena_prealloc(state->arena, &prealloc_idx_117);
...
exit_104:
ret->prealloc = prealloc_idx_104;
ret->result = result_104;
return;
}
...
arena_ptrs_t prealloc_idx_118 = *arena_prealloc(state->arena, &prealloc_idx_118);
uint32_t start_119 = start_118;
rnode_t* result_119 = NULL;
arena_ptrs_t prealloc_idx_119 = *arena_prealloc(state->arena, &prealloc_idx_119);
...
if (result_119 != NULL) {
result_118 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_118->flags = 0;
...
arena_ptrs_t prealloc_idx_120 = *arena_prealloc(state->arena, &prealloc_idx_120);
...
arena_ptrs_t prealloc_idx_121 = *arena_prealloc(state->arena, &prealloc_idx_121);
...
arena_ptrs_t prealloc_idx_122 = *arena_prealloc(state->arena, &prealloc_idx_122);
rnode_t* result_122_nt = call_eval(EVAL_dot, state, text, text_length, start_122);
if (result_122_nt) {
result_122 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
...
exit_118:
ret->prealloc = prealloc_idx_118;
ret->result = result_118;
return;
}
...
arena_ptrs_t prealloc_idx_123 = *arena_prealloc(state->arena, &prealloc_idx_123);
uint32_t start_124 = start_123;
rnode_t* result_124 = NULL;
arena_ptrs_t prealloc_idx_124 = *arena_prealloc(state->arena, &prealloc_idx_124);
uint32_t current_position_124 = start_124;
uint32_t start_125 = current_position_124;
rnode_t* result_125 = NULL;
arena_ptrs_t prealloc_idx_125 = *arena_prealloc(state->arena, &prealloc_idx_125);
...
if (result_125 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_124);
goto exit_124;
}
current_position_124 = result_125->end;
uint32_t start_126 = current_position_124;
rnode_t* result_126 = NULL;
arena_ptrs_t prealloc_idx_126 = *arena_prealloc(state->arena, &prealloc_idx_126);
rnode_t* result_126_nt = call_eval(EVAL_ws, state, text, text_length, start_126);
if (result_126_nt) {
result_126 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_126->flags = 0;
...
arena_ptrs_t prealloc_idx_127 = *arena_prealloc(state->arena, &prealloc_idx_127);
...
if (i_127 == 1 - 1) {
result_127 = arena_malloc(state->arena, sizeof(rnode_t));
result_127->flags = 0;
...
arena_ptrs_t prealloc_idx_128 = *arena_prealloc(state->arena, &prealloc_idx_128);
rnode_t* result_128_nt = call_eval(EVAL_ws, state, text, text_length, start_128);
if (result_128_nt) {
result_128 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_128->flags = 0;
...
arena_ptrs_t prealloc_idx_129 = *arena_prealloc(state->arena, &prealloc_idx_129);
rnode_t* result_129_nt = call_eval(EVAL_name, state, text, text_length, start_129);
if (result_129_nt) {
result_129 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
...
result_124 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 5);
...
exit_124:
if (result_124 != NULL) {
result_123 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_123->flags = 0;
...
arena_ptrs_t prealloc_idx_130 = *arena_prealloc(state->arena, &prealloc_idx_130);
rnode_t* result_130_nt = call_eval(EVAL_name, state, text, text_length, start_130);
if (result_130_nt) {
result_130 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
...
exit_123:
ret->prealloc = prealloc_idx_123;
ret->result = result_123;
return;
}
...
arena_ptrs_t prealloc_idx_131 = *arena_prealloc(state->arena, &prealloc_idx_131);
uint32_t current_position_131 = start_131;
uint32_t start_132 = current_position_131;
rnode_t* result_132 = NULL;
arena_ptrs_t prealloc_idx_132 = *arena_prealloc(state->arena, &prealloc_idx_132);
...
arena_ptrs_t prealloc_idx_133 = *arena_prealloc(state->arena, &prealloc_idx_133);
...
do {
result_134 = NULL;
arena_ptrs_t prealloc_idx_134 = *arena_prealloc(state->arena, &prealloc_idx_134);
uint32_t start_135 = start_134;
rnode_t* result_135 = NULL;
arena_ptrs_t prealloc_idx_135 = *arena_prealloc(state->arena, &prealloc_idx_135);
uint32_t current_position_135 = start_135;
uint32_t start_136 = current_position_135;
rnode_t* result_136 = NULL;
arena_ptrs_t prealloc_idx_136 = *arena_prealloc(state->arena, &prealloc_idx_136);
uint32_t start_137 = start_136;
rnode_t* result_137 = NULL;
arena_ptrs_t prealloc_idx_137 = *arena_prealloc(state->arena, &prealloc_idx_137);
...
if (result_137) {
result_136 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_136->flags = 0;
...
arena_ptrs_t prealloc_idx_138 = *arena_prealloc(state->arena, &prealloc_idx_138);
if (start_138 < text_length) {
uint8_t c_138 = text[start_138];
if (c_138 >= 0 && c_138 <= 255) {
result_138 = arena_malloc(state->arena, sizeof(rnode_t));
result_138->flags = 0;
...
if (!result_138) {
arena_reset_sp(state->arena, &prealloc_idx_138);
}
if (result_138 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_135);
goto exit_135;
...
arena_ptrs_t prealloc_idx_139 = *arena_prealloc(state->arena, &prealloc_idx_139);
if (start_139 < text_length) {
uint8_t c_139 = text[start_139];
if (c_139 >= 0 && c_139 <= 255) {
result_139 = arena_malloc(state->arena, sizeof(rnode_t));
result_139->flags = 0;
...
result_135 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
result_135->flags = 0;
...
exit_135:
if (result_135 != NULL) {
result_134 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_134->flags = 0;
...
arena_ptrs_t prealloc_idx_140 = *arena_prealloc(state->arena, &prealloc_idx_140);
uint32_t current_position_140 = start_140;
uint32_t start_141 = current_position_140;
rnode_t* result_141 = NULL;
arena_ptrs_t prealloc_idx_141 = *arena_prealloc(state->arena, &prealloc_idx_141);
uint32_t start_142 = start_141;
rnode_t* result_142 = NULL;
arena_ptrs_t prealloc_idx_142 = *arena_prealloc(state->arena, &prealloc_idx_142);
...
if (!result_142) {
result_141 = arena_malloc(state->arena, sizeof(rnode_t));
result_141->flags = 0;
...
arena_ptrs_t prealloc_idx_143 = *arena_prealloc(state->arena, &prealloc_idx_143);
...
result_140 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 2);
result_140->flags = 0;
...
result_133 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * num_children_133);
...
arena_ptrs_t prealloc_idx_144 = *arena_prealloc(state->arena, &prealloc_idx_144);
...
result_131 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
result_131->id = 131;
exit_131:
ret->prealloc = prealloc_idx_131;
ret->result = result_131;
return;
}
...
arena_ptrs_t prealloc_idx_145 = *arena_prealloc(state->arena, &prealloc_idx_145);
uint32_t current_position_145 = start_145;
uint32_t start_146 = current_position_145;
rnode_t* result_146 = NULL;
arena_ptrs_t prealloc_idx_146 = *arena_prealloc(state->arena, &prealloc_idx_146);
...
arena_ptrs_t prealloc_idx_147 = *arena_prealloc(state->arena, &prealloc_idx_147);
...
do {
result_148 = NULL;
arena_ptrs_t prealloc_idx_148 = *arena_prealloc(state->arena, &prealloc_idx_148);
uint32_t start_149 = start_148;
rnode_t* result_149 = NULL;
arena_ptrs_t prealloc_idx_149 = *arena_prealloc(state->arena, &prealloc_idx_149);
uint32_t current_position_149 = start_149;
uint32_t start_150 = current_position_149;
rnode_t* result_150 = NULL;
arena_ptrs_t prealloc_idx_150 = *arena_prealloc(state->arena, &prealloc_idx_150);
uint32_t start_151 = start_150;
rnode_t* result_151 = NULL;
arena_ptrs_t prealloc_idx_151 = *arena_prealloc(state->arena, &prealloc_idx_151);
...
if (result_151) {
result_150 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_150->flags = 0;
...
arena_ptrs_t prealloc_idx_152 = *arena_prealloc(state->arena, &prealloc_idx_152);
if (start_152 < text_length) {
uint8_t c_152 = text[start_152];
if (c_152 >= 0 && c_152 <= 255) {
result_152 = arena_malloc(state->arena, sizeof(rnode_t));
result_152->flags = 0;
...
if (!result_152) {
arena_reset_sp(state->arena, &prealloc_idx_152);
}
if (result_152 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_149);
goto exit_149;
...
arena_ptrs_t prealloc_idx_153 = *arena_prealloc(state->arena, &prealloc_idx_153);
if (start_153 < text_length) {
uint8_t c_153 = text[start_153];
if (c_153 >= 0 && c_153 <= 255) {
result_153 = arena_malloc(state->arena, sizeof(rnode_t));
result_153->flags = 0;
...
result_149 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
result_149->flags = 0;
...
exit_149:
if (result_149 != NULL) {
result_148 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_148->flags = 0;
...
arena_ptrs_t prealloc_idx_154 = *arena_prealloc(state->arena, &prealloc_idx_154);
uint32_t current_position_154 = start_154;
uint32_t start_155 = current_position_154;
rnode_t* result_155 = NULL;
arena_ptrs_t prealloc_idx_155 = *arena_prealloc(state->arena, &prealloc_idx_155);
uint32_t start_156 = start_155;
rnode_t* result_156 = NULL;
arena_ptrs_t prealloc_idx_156 = *arena_prealloc(state->arena, &prealloc_idx_156);
...
if (!result_156) {
result_155 = arena_malloc(state->arena, sizeof(rnode_t));
result_155->flags = 0;
...
arena_ptrs_t prealloc_idx_157 = *arena_prealloc(state->arena, &prealloc_idx_157);
...
result_154 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 2);
result_154->flags = 0;
...
result_147 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * num_children_147);
...
arena_ptrs_t prealloc_idx_158 = *arena_prealloc(state->arena, &prealloc_idx_158);
...
result_145 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
...
result_145->id = 145;
exit_145:
ret->prealloc = prealloc_idx_145;
ret->result = result_145;
return;
}
...
arena_ptrs_t prealloc_idx_159 = *arena_prealloc(state->arena, &prealloc_idx_159);
...
if (i_159 == 1 - 1) {
result_159 = arena_malloc(state->arena, sizeof(rnode_t));
...
ret->prealloc = prealloc_idx_159;
ret->result = result_159;
return;
}
...
arena_ptrs_t prealloc_idx_160 = *arena_prealloc(state->arena, &prealloc_idx_160);
...
do {
result_161 = NULL;
arena_ptrs_t prealloc_idx_161 = *arena_prealloc(state->arena, &prealloc_idx_161);
uint32_t start_162 = start_161;
rnode_t* result_162 = NULL;
arena_ptrs_t prealloc_idx_162 = *arena_prealloc(state->arena, &prealloc_idx_162);
uint32_t current_position_162 = start_162;
uint32_t start_163 = current_position_162;
rnode_t* result_163 = NULL;
arena_ptrs_t prealloc_idx_163 = *arena_prealloc(state->arena, &prealloc_idx_163);
uint32_t start_164 = start_163;
rnode_t* result_164 = NULL;
arena_ptrs_t prealloc_idx_164 = *arena_prealloc(state->arena, &prealloc_idx_164);
...
if (result_164) {
result_163 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_163->flags = 0;
...
arena_ptrs_t prealloc_idx_165 = *arena_prealloc(state->arena, &prealloc_idx_165);
if (start_165 < text_length) {
uint8_t c_165 = text[start_165];
if (c_165 >= 0 && c_165 <= 255) {
result_165 = arena_malloc(state->arena, sizeof(rnode_t));
result_165->flags = 0;
...
if (!result_165) {
arena_reset_sp(state->arena, &prealloc_idx_165);
}
if (result_165 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_162);
goto exit_162;
...
arena_ptrs_t prealloc_idx_166 = *arena_prealloc(state->arena, &prealloc_idx_166);
if (start_166 < text_length) {
uint8_t c_166 = text[start_166];
if (c_166 >= 0 && c_166 <= 255) {
result_166 = arena_malloc(state->arena, sizeof(rnode_t));
result_166->flags = 0;
...
if (!result_166) {
arena_reset_sp(state->arena, &prealloc_idx_166);
}
if (result_166 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_162);
goto exit_162;
...
result_162 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 3);
result_162->flags = 0;
...
exit_162:
if (result_162 != NULL) {
result_161 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*));
result_161->flags = 0;
...
arena_ptrs_t prealloc_idx_167 = *arena_prealloc(state->arena, &prealloc_idx_167);
uint32_t current_position_167 = start_167;
uint32_t start_168 = current_position_167;
rnode_t* result_168 = NULL;
arena_ptrs_t prealloc_idx_168 = *arena_prealloc(state->arena, &prealloc_idx_168);
uint32_t start_169 = start_168;
rnode_t* result_169 = NULL;
arena_ptrs_t prealloc_idx_169 = *arena_prealloc(state->arena, &prealloc_idx_169);
...
if (i_169 == 2 - 1) {
result_169 = arena_malloc(state->arena, sizeof(rnode_t));
result_169->flags = 0;
...
arena_reset_sp(state->arena, &prealloc_idx_169);
break;
}
}
if (!result_169) {
result_168 = arena_malloc(state->arena, sizeof(rnode_t));
result_168->flags = 0;
...
arena_reset_sp(state->arena, &prealloc_idx_168);
}
if (result_168 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_167);
goto exit_167;
}
current_position_167 = result_168->end;
uint32_t start_170 = current_position_167;
rnode_t* result_170 = NULL;
arena_ptrs_t prealloc_idx_170 = *arena_prealloc(state->arena, &prealloc_idx_170);
if (start_170 < text_length) {
uint8_t c_170 = text[start_170];
if (c_170 >= 0 && c_170 <= 255) {
result_170 = arena_malloc(state->arena, sizeof(rnode_t));
result_170->flags = 0;
...
if (!result_170) {
arena_reset_sp(state->arena, &prealloc_idx_170);
}
if (result_170 == NULL) {
arena_reset_sp(state->arena, &prealloc_idx_167);
goto exit_167;
...
result_167 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * 2);
result_167->flags = 0;
...
result_160 = arena_malloc(state->arena, sizeof(rnode_t) + sizeof(rnode_t*) * num_children_160);
result_160->flags = 0;
...
ret->prealloc = prealloc_idx_160;
ret->result = result_160;
return;
}
