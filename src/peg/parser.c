...
result_1->children[i] = dq_get(dq_1, i);
}
result_1->end = ((rnode_t*)dq_get(dq_1, num_children_1 - 1))->end;
result_1->id = 1;
} else {
...
result_8->children[i] = dq_get(dq_8, i);
}
result_8->end = ((rnode_t*)dq_get(dq_8, num_children_8 - 1))->end;
} else {
...
result_13->children[i] = dq_get(dq_13, i);
}
result_13->end = ((rnode_t*)dq_get(dq_13, num_children_13 - 1))->end;
result_13->id = 13;
} else {
...
result_25->children[i] = dq_get(dq_25, i);
}
result_25->end = ((rnode_t*)dq_get(dq_25, num_children_25 - 1))->end;
result_25->id = 25;
} else {
...
result_34->children[i] = dq_get(dq_34, i);
}
result_34->end = ((rnode_t*)dq_get(dq_34, num_children_34 - 1))->end;
} else {
...
result_42->children[i] = dq_get(dq_42, i);
}
result_42->end = ((rnode_t*)dq_get(dq_42, num_children_42 - 1))->end;
} else {
...
result_124->children[i] = dq_get(dq_124, i);
}
result_124->end = ((rnode_t*)dq_get(dq_124, num_children_124 - 1))->end;
} else {
...
result_138->children[i] = dq_get(dq_138, i);
}
result_138->end = ((rnode_t*)dq_get(dq_138, num_children_138 - 1))->end;
} else {
...
result_152->children[i] = dq_get(dq_152, i);
}
result_152->end = ((rnode_t*)dq_get(dq_152, num_children_152 - 1))->end;
} else {
...
ret->result = result_164;
return;
}
#define c(x) (((capture_t*)dq_get(context->capture, x))->str)
#define s(x) (((capture_t*)dq_get(context->capture, x))->start)
#define e(x) (((capture_t*)dq_get(context->capture, x))->end)
...
context->alias[4] = init_dq(16);
return;
}
void alias_frees_0(context_t* context) {
free_dq(context->alias[4]);
return;
}
...
context->alias[24] = init_dq(16);
return;
}
void alias_frees_18(context_t* context) {
free_dq(context->alias[24]);
return;
}
...
context->alias[31] = init_dq(16);
return;
}
void alias_frees_31(context_t* context) {
free_dq(context->alias[31]);
return;
}
...
context->alias[33] = init_dq(16);
context->alias[39] = init_dq(16);
return;
}
void alias_frees_32(context_t* context) {
free_dq(context->alias[33]);
free_dq(context->alias[39]);
return;
}
...
context->alias[41] = init_dq(16);
context->alias[45] = init_dq(16);
return;
}
void alias_frees_40(context_t* context) {
free_dq(context->alias[41]);
free_dq(context->alias[45]);
return;
}
...
context->alias[48] = init_dq(16);
return;
}
void alias_frees_47(context_t* context) {
free_dq(context->alias[48]);
return;
}
...
context->alias[55] = init_dq(16);
return;
}
void alias_frees_54(context_t* context) {
free_dq(context->alias[55]);
return;
}
...
context->alias[62] = init_dq(16);
return;
}
void alias_frees_61(context_t* context) {
free_dq(context->alias[62]);
return;
}
...
context->alias[72] = init_dq(16);
return;
}
void alias_frees_69(context_t* context) {
free_dq(context->alias[72]);
return;
}
...
context->alias[76] = init_dq(16);
return;
}
void alias_frees_73(context_t* context) {
free_dq(context->alias[76]);
return;
}
...
context->alias[81] = init_dq(16);
return;
}
void alias_frees_80(context_t* context) {
free_dq(context->alias[81]);
return;
}
...
context->alias[85] = init_dq(16);
return;
}
void alias_frees_84(context_t* context) {
free_dq(context->alias[85]);
return;
}
...
context->alias[89] = init_dq(16);
return;
}
void alias_frees_88(context_t* context) {
free_dq(context->alias[89]);
return;
}
...
context->alias[99] = init_dq(16);
return;
}
void alias_frees_96(context_t* context) {
free_dq(context->alias[99]);
return;
}
...
context->alias[105] = init_dq(16);
return;
}
void alias_frees_102(context_t* context) {
free_dq(context->alias[105]);
return;
}
...
context->alias[108] = init_dq(16);
return;
}
void alias_frees_108(context_t* context) {
free_dq(context->alias[108]);
return;
}
...
context->alias[110] = init_dq(16);
return;
}
void alias_frees_110(context_t* context) {
free_dq(context->alias[110]);
return;
}
...
context->alias[111] = init_dq(16);
return;
}
void alias_frees_111(context_t* context) {
free_dq(context->alias[111]);
return;
}
...
context->alias[112] = init_dq(16);
return;
}
void alias_frees_112(context_t* context) {
free_dq(context->alias[112]);
return;
}
...
context->alias[113] = init_dq(16);
return;
}
void alias_frees_113(context_t* context) {
free_dq(context->alias[113]);
return;
}
