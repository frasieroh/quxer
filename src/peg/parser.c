...
void* prealloc_idx_165 = arena_prealloc(state->arena);
...
void* prealloc_idx_166 = arena_prealloc(state->arena);
...
void* prealloc_idx_170 = arena_prealloc(state->arena);
